...
export const MODIFIER_POINT_OF_REFERENCE = 10;
export const ATTRIBUTES_MAX_POINTS = 70;
export const INTELLIGENCE_ATTRIBUTE_MODIFIER = "Intelligence";
export const API_HOST = "https://recruiting.verylongdomaintotestwith.ca";
